...
export class CreateTripAdapter {
   ...
   */
  selectedHotelInfoRequest(selectedLanguage :any,selectedHotelInfo:any,search:any){
    if (selectedHotelInfo.city == "Makkah") {search = this.appStore.makkahSearchId;}
    if (selectedHotelInfo.city == "Madina" || selectedHotelInfo.city == "Madinah" || selectedHotelInfo.city == "Medinah") {search = this.appStore.madinahSearchId;}
    var body = {
      search: search,
